...
export default function CtaSection() {
  return (
    <section id="cta-reservation" data-theme="dark" className="cta-section relative overflow-hidden py-32 flex flex-col items-center justify-center text-center">
      <div className="section-head max-w-3xl mx-auto px-6">
        <div>
        ...
        <div className="flex flex-wrap gap-4 justify-center items-center mt-6">
          <ArrowButton href={WHATSAPP_URL} external solid>Commander sur WhatsApp</ArrowButton>
          <ArrowButton href="/#lapins">Nos lapins</ArrowButton>
        </div>
      </div>
    </section>
  )
